# Im-Impatient-So-Just-Get-Me-Started

**Minimum you need to know to actually build and run this thing.**

> **Warning**: All performance claims and graphs in this project are simplified conceptual models. The author has not yet built or tested a physical version. Treat everything as a starting point for your own experiments.
...
Full detailed steps: [docs/build.md](docs/build.md)
