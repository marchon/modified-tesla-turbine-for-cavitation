...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{spacer_ring_1mm}
\caption{Example DXF profile: 1.0 mm spacer ring with lightening holes and annotations (importable into laser cutters and CAM software).}
\end{figure}
